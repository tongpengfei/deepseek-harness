...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/client/app-code-learning': { kind: 'none', reason: 'Browser-side programming course; registers nothing model-facing.' },
  ...
  'packages/client/ui-apps': { kind: 'none', reason: 'Browser-side Apps catalog and Slot owner; registers nothing model-facing.' },
